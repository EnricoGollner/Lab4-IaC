...
def predict():
    ...
    # Uma boa prática quando estamos trabalhando com Machine Learning é colocarmos os valores em float, para garantir maior precisão (previsão com a mais alta precisão)
